...
type categoryDep struct {
	fx.In
	Srv cms.CategoryService
}

func CategoryRoutes(t categoryDep, r *types.AdminRouter) {
	api := r.Group("/cms/category")
	api.GET("/all", t.all)
...
func (t categoryDep) all(c *gin.Context) {
	var listReq req.CategoryQueryReq
...
func (t categoryDep) list(c *gin.Context) {
...
func (t categoryDep) detail(c *gin.Context) {
	var idReq req.IdReq
...
func (t categoryDep) add(c *gin.Context) {
	var addReq req.CategoryAddReq
...
func (t categoryDep) edit(c *gin.Context) {
	var editReq req.CategoryEditReq
...
func (t categoryDep) delete(c *gin.Context) {
	var idReq req.IdReq
	if response.IsFailWithResp(c, util.VerifyUtil.Verify(c, &idReq)) {
		return
	}
